...
CTutorial::CTutorial()
	...
	m_pColliderMgr(ColliderMgr::GetInstance()),m_pPlayer(nullptr)
{
}
...
HRESULT CTutorial::Initialize()
{
	...
	CImageObject *pImage = new CImageObject(L"Obstacle", L"ZoneLight", D3DXVECTOR3(1750, 1530, 0), false, 0, -1, 1, 0.1f, 100);
	CObjectMgr::GetInstance()->AddObject(OBJECT_BUILDING, pImage);

	m_pPlayer = new CPlayer(D3DXVECTOR3(300,200,0));
